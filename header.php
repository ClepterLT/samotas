...
<header class="header ">
  <div class="row-big u-flex-center">
    ...
    <button type="button" class="nav-header__button">
        ...
        <svg class="nav-header__icon nav-header--hidden"><use xlink:href="<?php echo get_template_directory_uri() . '/assets/images/symbol-defs.svg#icon-close'?>"></use></svg>
    </button>
  </div>

  <div class="nav-header--mobile nav-header--hidden" id="nav-header--mobile">
        <nav class="nav-header">
            <?php
              $args = array(
                'menu' => 'primary-menu',
